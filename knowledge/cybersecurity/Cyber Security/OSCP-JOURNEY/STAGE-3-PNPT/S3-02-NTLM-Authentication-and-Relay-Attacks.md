...
[SMB] NTLMv2-SSP Hash     : jsmith::Company:1234567890abcdef:AAAABBBBCCCCDDDD...
```
...
```
[*] Authenticating against smb://192.168.0.50 as Company\Administrator SUCCEED
...
```
[*] Authenticating against ldaps://DC_IP as Company\DC01$ SUCCEED
