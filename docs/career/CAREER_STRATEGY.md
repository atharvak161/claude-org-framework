...
- **Experience is entry-level *for security specifically*:** ~4 years, but in IT support, network operations, and endpoint/identity administration — not in a security-titled role. The Company role includes self-initiated security assessments, which is the closest thing to relevant experience, but it is adjacent, not core.
...
- **CV/Portfolio:** Apply the CV and Portfolio review changes (reframed headline as transition, grouped skills, tool keywords, portfolio link, quantified Company bullet).
